    ...
    <aside class="card">
        <div class="list-group list-group-flush">
            <h6 class="list-group-label disabled my-1">المستخدمين</h6>
                ...
                <a class="indent-list-group-item list-group-item list-group-item-action {{ Request::is('manage/roles') ? "active" : "" }}" href="{{ route('permissions.index') }}"><i class="fa fa-sitemap fa-fw fa-lg ml-3"></i> إدارة الأدوار</a>
