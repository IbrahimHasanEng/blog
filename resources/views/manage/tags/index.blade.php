        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('tags.show', $tag->id) }}" class="">{{ $tag->name }}</td>
                    <td>
                        {{ $tag->posts()->count() }}
                    </td>
                    ...
                    <td>
                        ...
                        @include('partials._confirm-delete', ['title' => 'تأكيد حذف الوسم', 'question' => 'لدى بعض
                        المقالات الوسم &#x27;' . $tag->name . '&#x27;. هل أنت متأكد أنك تريد حذفه؟', 'idSuffex' => $tag->id])
                        @else 
                        @include('partials._confirm-delete', ['title' => 'تأكيد حذف الوسم', 'question' => 'هل أنت متأكد
                        أنك تريد حذف الوسم &#x27;' . $tag->name . '&#x27;؟', 'idSuffex' => $tag->id]) 
                        @endif {!! Form::close() !!}
                    </td>
                </tr>
                @endforeach
